...
export default class BlizzardSet extends ArtifactSet {
  computeTwoPieceBonuses(character: Character): void {
    ...
    character.calculatorStats.cryoDmgBonus.addAdditionalValue(new StatValue(15));
  }
  ...
  removeTwoSetBonuses(character: Character): void {
    ...
    character.calculatorStats.cryoDmgBonus.removeAdditionalValue(new StatValue(15));
  }
